                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-green-sharp bold uppercase">编辑博客</span>
                            </div>
                            <div class="tools">
                                                ...
                                                <c:forEach items="${tags}" var="tag">
                                                    <div class="col-md-3">
                                                        <label class="checkbox-inline">
                                                            <input type="checkbox" name="tagCheckbox" value="${tag.id}"
                                                            <c:if test="${fn:contains(blogTags, tag.id)}">
                                                                   checked="checked"
                                                            </c:if>
                                                            >${tag.name}</label>
                                                    </div>
                                    ...
                                    <div class="form-actions">
                                        <div class="row">
                                            <div class="col-md-offset-4 col-md-8">
                                                <button type="button" class="btn green" onclick="blogManager.edit();">
                                                    Submit
                                                </button>
                                            </div>
                                        </div>
