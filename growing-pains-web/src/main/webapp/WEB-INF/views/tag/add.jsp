                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-green-sharp bold uppercase">新建标签</span>
                            </div>
                            <div class="tools">
                            ...
                            <form class="form-horizontal form-bordered">
                                <div class="form-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" id="tagName" class="form-control maxlength-handler" name="product[meta_title]" maxlength="100" placeholder="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" id="tagDesc" class="form-control maxlength-handler" name="product[meta_title]" maxlength="100" placeholder="">
                                    ...
                                    <div class="form-actions">
                                        <div class="row">
                                            <div class="col-md-offset-4 col-md-8">
                                                <button type="button" class="btn green" onclick="tagManager.add();">Submit</button>
